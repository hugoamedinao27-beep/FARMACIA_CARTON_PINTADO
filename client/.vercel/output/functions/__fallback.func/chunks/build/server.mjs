...
import { l as parseURL, e as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, c as createError$1, x as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./forgot-password-DWvbcvS6.mjs')
  },
  {
    name: "inicio",
    path: "/inicio",
  ...
  },
  {
    name: "reset-password",
    path: "/reset-password",
    component: () => import('./reset-password-CcRKPLM1.mjs')
  },
  {
    name: "index",
    path: "/",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-wBaBf7HX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BuuHMW1s.mjs'));
