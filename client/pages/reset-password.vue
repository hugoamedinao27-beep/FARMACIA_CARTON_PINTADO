    ...
    <div class="login-card">
      <div class="login-header">
        <div class="brand-badge">
          <img src="/images/key.svg" class="pill-emoji icon-img" alt="Restablecer" />
          <div class="pulse-ring"></div>
        </div>
        <h2>Nueva Contraseña</h2>
        <p class="matrix-text">RESTABLECIENDO ACCESO</p>
      </div>
      ...
      <form @submit.prevent="handleResetPassword" class="login-form">
        ...
        <div class="input-group">
          ...
          <div class="input-with-icon">
            <img src="/images/lock-closed.svg" class="input-icon icon-img" alt="Confirmar" />
        ...
        <button type="submit" :disabled="loading" class="btn-login-submit">
          <span v-if="!loading">RESTABLECER <img src="/images/arrow-right.svg" class="arrow icon-img" alt="→" style="width:1em;height:1em;vertical-align:middle;" /></span>
