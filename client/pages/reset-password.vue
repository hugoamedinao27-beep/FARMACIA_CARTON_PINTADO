    ...
    <div class="login-card">
      <div class="login-header">
        <div class="brand-badge">
          <img src="/images/key.svg" class="brand-logo" alt="Restablecer" />
        </div>
        <h2>Nueva Contraseña</h2>
        <p class="subtitle">Restableciendo acceso</p>
      </div>

      <form v-if="!successMessage" @submit.prevent="handleResetPassword" class="login-form">
        <div class="input-group">
          <label for="password">Nueva contraseña</label>
          <div class="input-with-icon">
            <img src="/images/lock-closed.svg" class="input-icon" alt="Contraseña" />
            <input id="password" v-model="password" type="password" placeholder="Ingresa la nueva contraseña" required />
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-with-icon">
            <img src="/images/lock-closed.svg" class="input-icon" alt="Confirmar" />
            <input id="confirm" v-model="confirmPassword" type="password" placeholder="Repite la contraseña" required />
          </div>
        </div>

        <button type="submit" :disabled="loading" class="btn-login-submit">
          <span v-if="!loading">Restablecer <img src="/images/arrow-right.svg" class="arrow" alt="→" /></span>
...
onMounted(() => {
  ...
  if (!token) {
    errorMessage.value = 'Token de restablecimiento no proporcionado.'
  }
})
